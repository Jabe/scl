...
public class UTF8Buffer: Buffer {
	...
	public UTF8Buffer(Stream s, bool isUserStream) : base(s, isUserStream)
	{
	}

	protected UTF8Buffer(Buffer b) : base(b)
	{
	}
...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 10; i <= 10; ++i) start[i] = 1;
		for (int i = 59; i <= 59; ++i) start[i] = 2;
		for (int i = 0; i <= 8; ++i) start[i] = 3;
		for (int i = 11; i <= 12; ++i) start[i] = 3;
		for (int i = 14; i <= 31; ++i) start[i] = 3;
		for (int i = 33; i <= 33; ++i) start[i] = 3;
		for (int i = 35; i <= 58; ++i) start[i] = 3;
		for (int i = 60; i <= 65535; ++i) start[i] = 3;
	...
	public Scanner (string fileName) {
		try {
			...
			buffer = new UTF8Buffer(stream, false);
			Init();
		} catch (IOException) {
